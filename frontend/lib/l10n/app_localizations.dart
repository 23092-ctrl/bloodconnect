...
abstract class AppLocalizations {
  ...
  /// No description provided for @notYetEligible.
  ///
  /// In en, this message translates to:
  /// **'Not yet eligible'**
  String get notYetEligible;
  ...
  /// No description provided for @nationalBloodStock.
  ///
  /// In en, this message translates to:
  /// **'National Blood Stock'**
  String get nationalBloodStock;
  ...
  /// No description provided for @nearbyBloodCenters.
  ///
  /// In en, this message translates to:
  /// **'Nearby Blood Centers'**
  String get nearbyBloodCenters;

  /// No description provided for @shortageAlerts.
  ///
  /// In en, this message translates to:
  /// **'Shortage Alerts'**
  String get shortageAlerts;

  /// No description provided for @shortageAlertsSubtitle.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @youCanDonateToday.
  ///
  /// In en, this message translates to:
  /// **'You can donate today!'**
  String get youCanDonateToday;

  /// No description provided for @findNearestBloodBank.
  ///
  /// In en, this message translates to:
  /// **'Find your nearest blood bank'**
  String get findNearestBloodBank;

  /// No description provided for @donatedRecently.
  ///
  /// In en, this message translates to:
  /// **'You donated recently. Thank you!'**
  String get donatedRecently;
  ...
  ///
  /// In en, this message translates to:
  /// **'{days} days until next donation'**
  String daysUntilNextDonation(int days);

  /// No description provided for @lastDonationDaysAgo.
  ///
  /// In en, this message translates to:
  /// **'Last donation: {days} days ago'**
